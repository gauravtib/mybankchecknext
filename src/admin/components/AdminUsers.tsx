...
export function AdminUsers() {
  ...
  const handleAddUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatusMessage(`Failed to create user: ${error instanceof Error ? error.message : 'Unknown error'}`);
  ...
  const handleEditUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Call the secure edge function to update user
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      setActionStatus('error');
      setStatusMessage(`Failed to delete user: ${error instanceof Error ? error.message : 'Unknown error'}`);
